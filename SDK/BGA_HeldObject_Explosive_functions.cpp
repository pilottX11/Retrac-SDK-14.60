...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class AFortPlayerController*            LastDamageInstigator_0                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ABGA_HeldObject_Explosive_C::Explode_and_Die_with_Delay(class AFortPlayerController* LastDamageInstigator_0)
{
	static class UFunction* Func = nullptr;
