...
// Parameters:
// const class FText&                      QuestDescription                                       (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
...
void UMiniChallenges_C::AddQuestDetails(const class FText& QuestDescription, int32 AchivedCount, int32 GoalCount)
{
	...
	Parms.QuestDescription = std::move(QuestDescription);
