...
// Function MatchXPTotalEntry.MatchXPTotalEntry_C.UpdateXpScoreAudio
// (BlueprintCallable, BlueprintEvent)

void UMatchXPTotalEntry_C::UpdateXpScoreAudio()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MatchXPTotalEntry_C", "UpdateXpScoreAudio");

	UObject::ProcessEvent(Func, nullptr);
}


// Function MatchXPTotalEntry.MatchXPTotalEntry_C.Destruct
// (BlueprintCosmetic, Event, Public, BlueprintEvent)

void UMatchXPTotalEntry_C::Destruct()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MatchXPTotalEntry_C", "Destruct");
