...
void UBasicInteractionWidget_C::UpdateDescription(const class FText& Description_0, const struct FLinearColor& DescriptionColor, const class FText& SubDescription, const struct FLinearColor& SubDescriptionColor)
{
