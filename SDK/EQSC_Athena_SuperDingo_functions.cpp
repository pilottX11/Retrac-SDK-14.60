...
#include "EQSC_Athena_SuperDingo_classes.hpp"
#include "EQSC_Athena_SuperDingo_parameters.hpp"
...
void UEQSC_Athena_SuperDingo_C::ProvideSingleLocation(class UObject* QuerierObject, class AActor* QuerierActor, struct FVector* ResultingLocation) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("EQSC_Athena_SuperDingo_C", "ProvideSingleLocation");

	Params::EQSC_Athena_SuperDingo_C_ProvideSingleLocation Parms{};
