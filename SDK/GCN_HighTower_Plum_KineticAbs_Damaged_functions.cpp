...
#include "GCN_HighTower_Plum_KineticAbs_Damaged_classes.hpp"
#include "GCN_HighTower_Plum_KineticAbs_Damaged_parameters.hpp"
...
void UGCN_HighTower_Plum_KineticAbs_Damaged_C::OnBurstGeneric(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UFXSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UMatineeCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_HighTower_Plum_KineticAbs_Damaged_C", "OnBurstGeneric");

	Params::GCN_HighTower_Plum_KineticAbs_Damaged_C_OnBurstGeneric Parms{};
