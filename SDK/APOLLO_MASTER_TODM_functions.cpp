...
// Function APOLLO_MASTER_TODM.APOLLO_MASTER_TODM_C.OnDayPhaseChange
// (BlueprintCosmetic, Event, Public, BlueprintEvent)

void AAPOLLO_MASTER_TODM_C::OnDayPhaseChange()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("APOLLO_MASTER_TODM_C", "OnDayPhaseChange");
