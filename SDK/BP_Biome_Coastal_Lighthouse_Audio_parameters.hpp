...
DUMPER7_ASSERTS_BP_Biome_Coastal_Lighthouse_Audio_C_On_Game_Phase_Step_Changed;
...
public:
	...
	TScriptInterface<class IFortSafeZoneInterface> K2Node_CustomEvent_SafeZoneInterface;             // 0x0010(0x0010)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	TDelegate<void(const TScriptInterface<class IFortSafeZoneInterface>& SafeZoneInterface, const EAthenaGamePhaseStep GamePhaseStep)> K2Node_CreateDelegate_OutputDelegate; // 0x0034(0x0010)(ZeroConstructor, NoDestructor)
	bool                                          CallFunc_IsPlaying_ReturnValue;                    // 0x0044(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
DUMPER7_ASSERTS_BP_Biome_Coastal_Lighthouse_Audio_C_ExecuteUbergraph_BP_Biome_Coastal_Lighthouse_Audio;
