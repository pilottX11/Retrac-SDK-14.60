...
void AApollo_Tree_RedAlder_C::handleCvarChanged(const class FString& CVar)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Apollo_Tree_RedAlder_C", "handleCvarChanged");

	Params::Apollo_Tree_RedAlder_C_handleCvarChanged Parms{};
...
void AApollo_Tree_RedAlder_C::validateShadowImposter()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Apollo_Tree_RedAlder_C", "validateShadowImposter");
