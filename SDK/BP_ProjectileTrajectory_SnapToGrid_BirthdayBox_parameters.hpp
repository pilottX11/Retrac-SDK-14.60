...
struct BP_ProjectileTrajectory_SnapToGrid_BirthdayBox_C_ExecuteUbergraph_BP_ProjectileTrajectory_SnapToGrid_BirthdayBox final
{
public:
	...
	bool                                          CallFunc_GreaterEqual_FloatFloat_ReturnValue_2;    // 0x004C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	struct FVector                                CallFunc_Map_Find_Value_1;                         // 0x0060(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_GridSnap_Float_ReturnValue_1;             // 0x0090(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_GridSnap_Float_ReturnValue_2;             // 0x0094(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FHitResult                             CallFunc_K2_SetWorldLocationAndRotation_SweepHitResult; // 0x00C0(0x008C)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	struct FVector                                CallFunc_Add_VectorVector_ReturnValue_3;           // 0x019C(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<struct FHitResult>                     CallFunc_BoxTraceMultiByProfile_OutHits;           // 0x01B8(0x0010)(ReferenceParm, ContainsInstancedReference, HasGetValueTypeHash)
	bool                                          CallFunc_BoxTraceMultiByProfile_ReturnValue;       // 0x01C8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_1C9[0x3];                                      // 0x01C9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FHitResult                             CallFunc_Array_Get_Item;                           // 0x01CC(0x008C)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	class APawn*                                  CallFunc_GetInstigator_ReturnValue_1;              // 0x02F0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_BP_ProjectileTrajectory_SnapToGrid_BirthdayBox_C_ExecuteUbergraph_BP_ProjectileTrajectory_SnapToGrid_BirthdayBox;
...
struct BP_ProjectileTrajectory_SnapToGrid_BirthdayBox_C_HandleGridSnapUpdates final
{
public:
...
DUMPER7_ASSERTS_BP_ProjectileTrajectory_SnapToGrid_BirthdayBox_C_HandleGridSnapUpdates;
