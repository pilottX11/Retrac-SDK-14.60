...
#include "GCN_Athena_GenericHeldObject_HitWorld_TnTina_classes.hpp"
#include "GCN_Athena_GenericHeldObject_HitWorld_TnTina_parameters.hpp"


namespace SDK
{

// Function GCN_Athena_GenericHeldObject_HitWorld_TnTina.GCN_Athena_GenericHeldObject_HitWorld_TnTina_C.OnBurst
...
void UGCN_Athena_GenericHeldObject_HitWorld_TnTina_C::OnBurst(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UMatineeCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_Athena_GenericHeldObject_HitWorld_TnTina_C", "OnBurst");

	Params::GCN_Athena_GenericHeldObject_HitWorld_TnTina_C_OnBurst Parms{};
