...
public:
	...
	TArray<class UStaticMeshComponent*>           K2Node_MakeArray_Array;                            // 0x0030(0x0010)(ReferenceParm, ContainsInstancedReference, HasGetValueTypeHash)
...
public:
	...
	struct FHitResult                             CallFunc_K2_AddLocalRotation_SweepHitResult;       // 0x005C(0x008C)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	float                                         CallFunc_RandomFloatInRange_ReturnValue_1;         // 0x00EC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FHitResult                             CallFunc_K2_SetRelativeTransform_SweepHitResult;   // 0x0150(0x008C)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	bool                                          CallFunc_IsDedicatedServer_ReturnValue_1;          // 0x01DC(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
